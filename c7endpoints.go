...
type endpoints struct {
	...
	// "https://api.commerce7.com/v1/meta-data-config/{:obj}" - Requires an object appended; allocation, club-membership, collection, customer, customer-address, order, product, reservation, experience
	//
	// Can append a uuid in a GET request https://api.commerce7.com/v1/meta-data-config/{:obj}/{:uuid}
	MetaDataConfigObj             string
	MetaDataConfigObjIsUniqueCode string // "https://api.commerce7.com/v1/meta-data-config/{:obj}/is-unique-code" - Requires an object inserted; allocation, club-membership, collection, customer, customer-address, order, product, reservation, experience
...
func GetEndpoints(baseURL string) *endpoints {
	return &endpoints{
		...
		MetaDataConfigObjIsUniqueCode: baseURL + "/meta-data-config/{:obj}/is-unique-code",
		Order:                         baseURL + "/order",
